...
utils::write.table(x=1,file=file,...)
...
read.table <- function(file, header=FALSE, sep="", ..., choose.columns=NULL, RtoolsBin=paste0(c("C:/Program Files","C:/Tools","//evdad.admin.ch/AGROSCOPE_OS/2/5/2/1/3/1/4269/B0000/driversEtc","//evdad.admin.ch/AGROSCOPE_OS/0/4/5/3811/Dokumente/R_Uebung/sonstigeFiles/Rtools/bin"),"/Rtools/bin")){
...
return( utils::read.table(pipe(paste0(RtoolsCut, " -f",paste0(choose.columns,collapse=","), " -d", sep," ", getFullyQualifiedFileName(file)) ), header=header, sep=sep, ...))
}
} else {
tryCatch({
...
RtoolsBin=paste0(c("C:/Program Files","C:/Tools","//evdad.admin.ch/AGROSCOPE_OS/2/5/2/1/3/1/4269/B0000/driversEtc","//evdad.admin.ch/AGROSCOPE_OS/0/4/5/3811/Dokumente/R_Uebung/sonstigeFiles/Rtools/bin"),"/Rtools/bin"), ...){
